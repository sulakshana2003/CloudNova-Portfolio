          ...
          <div className="flex flex-col gap-8 md:flex-row md:items-end md:justify-between">
            <div className="max-w-2xl">
              ...
              <p className="mt-4 text-neutral-600">
                A selection of products and client work — e-commerce, POS
                systems, dashboards, and modern websites built with clean UI and
                scalable code.
              </p>
            </div>
            ...
            <div className="grid w-full gap-3 md:max-w-sm">
              ...
              <StatCard
                label="Focus"
                value="E-commerce"
                hint="Inventory + online shopping"
              />
              <StatCard
                label="Stack"
                value="Full-stack"
                hint="React + Node + MongoDB"
              />
            </div>
          </div>
        </div>
