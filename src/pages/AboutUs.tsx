  ...
  return (
    <div className="au-page">
      ...
      <footer className="au-footer">
        <div className="au-container">
          <section className="au-cta" aria-label="Call to action">
            <div className="au-ctaLeft">
              <h2 className="au-ctaTitle">
                Ready To Transform Your Ideas <br />
                Into Impactful Digital Solutions?
              </h2>
            </div>

            <div className="au-ctaRight">
              <div className="au-ctaSmall">Let’s build together.</div>
              <a className="au-ctaBtn" href="/contact">
                Book a free consultation <ArrowIcon />
              </a>
            </div>
          </section>

          <div className="au-footerGrid" aria-label="Footer links">
            <div className="au-footerCol">
              <div className="au-brand">
                <div className="au-brandMark" aria-hidden="true">
                  CN
                </div>
                <div className="au-brandText">
                  <div className="au-brandName">CloudNova.</div>
                  <div className="au-brandTag">Digital Solutions</div>
                </div>
              </div>

              <p className="au-footerText">
                Your trusted partner in creating powerful digital solutions,
                from custom software and mobile apps to eCommerce platforms, SEO,
                and AI-driven developments.
              </p>

              <div className="au-social">
                <a className="au-socialBtn" href="#" aria-label="Facebook">
                  f
                </a>
                <a className="au-socialBtn" href="#" aria-label="LinkedIn">
                  in
                </a>
              </div>
            </div>
            ...
            <div className="au-footerCol">
              <div className="au-footerHeading">Quick Links</div>
              <ul className="au-footerList">
                <li><a href="/">Home</a></li>
            ...
            <div className="au-footerCol">
              <div className="au-footerHeading">Our Services</div>
              <ul className="au-footerList">
                <li><a href="/services#ai">AI Solutions</a></li>
                <li><a href="/services#software">Software Development</a></li>
                <li><a href="/services#mobile">Mobile App Development</a></li>
            ...
            <div className="au-footerCol">
              <div className="au-footerHeading">Contact Us</div>
              <div className="au-contact">
                <div className="au-contactRow">
                  <PinIcon />
                  <div>
                    Add the address here <br />
                    City and place as well
                  </div>
                </div>
                <div className="au-contactRow">
                  <PhoneIcon />
                  <div>+94 70 488 1414</div>
                </div>
                <div className="au-contactRow">
                  <MailIcon />
                  <div>cloudnova.team@gmail.com</div>
                </div>
              </div>
            </div>
          </div>

          <div className="au-footerBottom">
            <span>
